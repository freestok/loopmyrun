        ...
        <div class="row h-100">
            <div class="col-md-3">
                <ul class="nav nav-pills nav-fill">
                    <li class="nav-item">
                      <a class="nav-link active" href="#">Loop Finder <i class="fa fa-repeat" aria-hidden="true"></i></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link disabled" href="#">Loop Results</a>
                    </li>
                  </ul>
                <form id="loopForm">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="distanceUnit" id="mi" value="mile" required>
